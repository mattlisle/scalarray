...
trait ArrayNdOps[@specialized(Int, Long, Float, Double) A] extends ArrayNdNumericOps[A] {
  ...
  /**
    ...
    */
  def map[@specialized(Int, Long, Float, Double) B: Numeric: ClassTag](f: A => B): ArrayNd[B]
